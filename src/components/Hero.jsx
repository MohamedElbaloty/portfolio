    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold mb-6 sm:mb-8 gradient-text leading-tight px-4"
        >
          {t.hero.title}
        </motion.h1>
        ...
        <motion.p
          variants={itemVariants}
          className="text-base sm:text-xl md:text-2xl lg:text-3xl text-gray-300 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-4"
        >
          {t.hero.description}
        </motion.p>
