...
export const projectsData = {
  en: [
    ...
    },
    {
      ...
      marketKey: 'kw',
      market: 'Kuwait',
      description: 'A simple corporate website that presents the company\'s services and projects in a clear and straightforward way.',
      fullDescription: 'Emaar Group Kuwait is a simple, clean corporate website focused on presenting the company\'s services and projects. It provides the essential information customers need (services, projects, and contact details) with a straightforward layout and smooth navigation, without heavy visual complexity.',
      tools: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Node.js', 'MongoDB', 'EmailJS'],
      image: 'https://images.unsplash.com/photo-1640494958956-f3b8c57a48ac?auto=format&fit=crop&w=800&h=600&q=80',
      video: null,
  ...
  ar: [
    ...
    },
    {
      ...
      marketKey: 'kw',
      market: 'الكويت',
      description: 'موقع شركة بسيط لعرض معلومات خدمات ومشاريع الشركة بشكل واضح ومباشر.',
      fullDescription: 'إعمار جروب الكويت هو موقع شركة بسيط ومرتب يركز على عرض خدمات ومشاريع الشركة والمعلومات الأساسية مثل وسائل التواصل. تصميمه مباشر وسهل التصفح بدون تعقيد بصري كبير.',
      tools: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Node.js', 'MongoDB', 'EmailJS'],
      image: 'https://images.unsplash.com/photo-1640494958956-f3b8c57a48ac?auto=format&fit=crop&w=800&h=600&q=80',
      video: null,
      link: 'https://emaargroup.com.kw',
