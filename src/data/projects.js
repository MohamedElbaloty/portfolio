  ...
  en: [
    {
      ...
      marketKey: 'sa',
      market: 'Saudi Arabia',
      description: 'Housing & investment financing in K.S.A. Top bank offers.',
    ...
    },
    {
      ...
      marketKey: 'eg',
      market: 'Egypt',
      description: 'Robotics & programming academy. Tracking & certificates.',
    ...
    },
    {
      ...
      marketKey: 'kw',
      market: 'Kuwait',
      description: 'Kuwait HVAC ducting & AC piping supplies. Simple site.',
    ...
    },
    {
      ...
      category: 'production',
      description: 'AI promotional videos for brands (no real filming).',
    ...
    },
    {
      ...
      category: 'production',
      description: 'Automation workflows (n8n-style). Streamline operations.',
    ...
    },
    {
      ...
      category: 'production',
      description: '2D/3D animation & motion. Brands & campaigns.',
